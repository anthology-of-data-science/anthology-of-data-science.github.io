...
- curate content for different professional learning paths, combining various existing open access materials that can be readily shared also in low-resource settings (disclosure: I do a lot of work for [PharmAccess Foundation](https://pharmaccess.org));
