...
Python is one of the most widely used programming languages for data science. For those new to Python, I have curated a selection of books and online tutorials form [Real Python](https://realpython.com) to get you going.
