...
A selection of what I think are [the best open access textbooks](books.qmd) is provided as a digital bookshelf. All the books included are open access, thanks to their respective authors! They should keep you busy for a while.

### Lectures

I am gradually rewriting my lectures as [Revealjs presentations](https://quarto.org/docs/presentations/revealjs/). More will be added over time.
