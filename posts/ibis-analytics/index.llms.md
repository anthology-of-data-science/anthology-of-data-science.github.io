...
The dashboard can be [viewed as a Streamlit app](https://ibis-analytics.streamlit.app) in your browser or embedded in this page below.

You need to enable JavaScript to run this app.

## Architecture

The source of truth for the project’s architecture [is the repository of code](https://github.com/ibis-project/ibis-analytics). A point-in-time description and snapshots of the code are below.
...
> **WARNING:**
>
> Note that ingesting the PyPI download data from BigQuery will incur costs of 8 euros if you are above your free tier. To save cost, you can download a snapshot of the data from 23 June 2024 [here](https://drive.google.com/drive/folders/1yLcvCpoGBLfRxkLFQiqCUWzDwFrhedei?usp=drive_link).
...
[![System usage](top.png)](top.png "System usage")
...
[![Dagster GUI](dag.png)](dag.png "Dagster GUI")
...
[![Dashboard local](preview.png)](preview.png "Dashboard local")

Dashboard local

[![Dashboard metrics](thumbnail.png)](thumbnail.png "Dashboard metrics")
...
The source code can be found and stolen from [on the `ibis-analytics` repository](https://github.com/ibis-project/ibis-analytics) – feel free to open an issue, PR, or comment below!
