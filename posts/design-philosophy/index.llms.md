...
[![](./computer_tables.png)](./computer_tables.png)
...
[![](./a_simple_table.png)](./a_simple_table.png)
...
[![](./uruk_tablet_with_annotations.png)](./uruk_tablet_with_annotations.png)
...
[![](./nippur_cuneiform_tablet.png)](./nippur_cuneiform_tablet.png)
...
[![](./snippets_from_manual_tablular_presentation.png)](./snippets_from_manual_tablular_presentation.png)
...
[![](./composition_of_a_table_in_GT.png)](./composition_of_a_table_in_GT.png)
...
- scientific notation (`fmt_scientific()`): 1.34 × 10⁵
...
We’re very excited about where things are going with [**Great Tables**](https://github.com/posit-dev/great-tables) and we geniunely appreciate community feedback. If ever you want to talk tables with us, you’re always welcome to jump into our [Discord Server](https://discord.com/invite/Ux7nrcXHVV) and drop us a line!
