...
::: {.callout-warning}
Note that ingesting the PyPI download data from BigQuery will incur costs of 8 euros if you are above your free tier. So save cost, you can download a snapshot of the data from 23 June 2024 [here](https://drive.google.com/drive/folders/1yLcvCpoGBLfRxkLFQiqCUWzDwFrhedei?usp=drive_link).  
:::
